...
const vistaFavoritos = (() => {
  const contenedor = document.getElementById("contenedor-favoritos") as HTMLElement | null;

  function renderFavoritos(productos: Producto[]): void {
    if (!contenedor) {
